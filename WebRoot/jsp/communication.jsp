		...
		<div class="art-sheet clearfix">
			...
			<nav class="art-nav">
				<ul class="art-hmenu">
					...
					<li><a href="${ctx }/jsp/communication.jsp" class="active">师生互动</a></li>
					<!-- ---------2:教师------1：学生----------- -->
					<c:choose>
			...
			<div class="art-layout-wrapper">
				...
				<!-- -----------------------右边视频------------------------ -->
				<div class="right">
					<iframe   scrolling="no"  name="main" src="${ctx }/servlet/BbsServlet?type=search&p=all&index=1" ></iframe>
				</div>
			</div>
